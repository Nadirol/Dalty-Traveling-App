...
const ReviewCard = ({ id, content, name, title, prevReview, nextReview, dataLength }) => {    
    return (
        <div className="bg-white dark:bg-semi-black rounded-[14px] p-[30px] snap-start ">
            <div className="flex flex-col justify-between xl:min-h-[250px]">
                <p className="text-dark-gray dark:text-semi-light-yellow font-inter font-normal text-lg mb-7 animate-fade-in">{content}</p>
                <div className="flex justify-between items-end">
                    <div className="">
                        ...
                        <h5 className="text-dark-gray dark:text-semi-light-yellow font-inter font-normal 
                            text-xs leading-none animate-fade-in">
                            {title}
                        </h5>
                    </div>
