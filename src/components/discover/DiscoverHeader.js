...
const DiscoverHeader = ({ handleSearchSubmit, searchValue, handleSearchChange, clearSearchValue, 
    ...
    nameValue, handleNameChange }) => {
        ...
        return (
            <div className="w-full mx-auto mb-8 flex -md:flex-col -md:gap-8 items-center justify-between px-4">
                <Link to='/home'>
                ...
                <form onSubmit={(e) => handleSearchSubmit(e)}
                    className="bg-white px-4 md:px-7 py-2 rounded-[100vw] xl:w-discover-search-form mx-auto 
                        relative">
                    <div className="relative z-30 flex items-center">
                        <div className="text-regular-gray text-xl pr-2 rounded-[50%] hover:text-orange" onClick={toggleSearchConfigs}>
                            <BsFilterLeft/>
                        </div>
                    ...
                    <div className={`absolute z-10 bg-white top-0 left-0 w-full rounded-t-[2rem] rounded-b-xl overflow-hidden
                        ...
                        <div className="flex gap-6 items-center mb-4">
                            ...
                            text-dark-gray font-inter font-normal text-base leading-none w-full md:min-w-[100px] md:w-[15%] text-center
                                placeholder:text-medium-gray placeholder:text-sm placeholder:leading-none placeholder:font-normal
                ...
                <div className={`${ navMenuOpen ? '-md:fixed' : '-md:hidden'} -md:bottom-1/2 -md:right-1/2 
                    -md:translate-x-1/2 -md:translate-y-1/2 z-30 -md:p-9 -md:rounded-xl`}>
